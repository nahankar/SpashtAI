...
"""
SpashtAI Voice Agent - MINIMAL TEST VERSION
Just basic AWS Nova Sonic connection, no recording for now
"""
...
async def entrypoint(ctx: JobContext):
    """
    MINIMAL TEST - Just AWS Nova Sonic connection
    """
    logger.info("🚀 MINIMAL TEST AGENT STARTING")
    ...
    logger.info(f"👥 Participants already in room: {len(ctx.room.remote_participants)}")
